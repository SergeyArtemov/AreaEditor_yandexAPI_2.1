...
type
  T_Main = class(TForm)
    ...
    _del_SzPan_IntervalScheme: TSizedPanel;
    _del_SpB_IntervalScheme_Add: TSpeedButton;
    _del_SpB_IntervalScheme_Del: TSpeedButton;
    _del_CatBtns_IntervalScheme: TCategoryButtons;
    _del_DTP_IntervalScheme_Begin: TDateTimePicker;
    _del_Label7: TLabel;
    _del_Label8: TLabel;
    _del_DTP_IntervalScheme_End: TDateTimePicker;
    _del_BB_IntervalScheme_Close: TBitBtn;
    _del_SpB_IntervalScheme_Clear: TSpeedButton;
    _del_SpB_IntervalScheme_Save: TSpeedButton;
    _del_SpB_IntervalScheme_Load: TSpeedButton;
    _del_SpB_IntervalScheme_Edit: TSpeedButton;
    _del_Ed_IntervalScheme_Name: TEdit;
    _del_Label9: TLabel;
    PM_IntervalScheme: TPopupMenu;
    N_IntervalList_AddOne: TMenuItem;
    N_IntervalList: TMenuItem;
    _del_SpB_IntervalScheme_Accept: TSpeedButton;
    _del_SpB_IntervalScheme_AcceptMode: TSpeedButton;
    ...
    _del_SpB_SetOut_SzPan_IntervalScheme: TSpeedButton;
...
(* --- Области, интервалы ----------------------------------------------------------------------- *)
    ...
    (*old_Scheme*)//procedure _del_CatBtns_IntervalSchemeSelectedCategoryChange(Sender: TObject; const Category: TButtonCategory);
    (*old_Scheme*)//procedure _del_SzPan_IntervalSchemeResize(Sender: TObject);
    (*old_Scheme*)//procedure CatBtns_IntervalSchemeCategoryClicked(Sender: TObject; const Category: TButtonCategory);
    (*old_Scheme*)//procedure _del_CatBtns_IntervalSchemeReorderCategory(Sender: TObject; const SourceCategory,TargetCategory: TButtonCategory);
    (*old_Scheme*)//procedure _del_CatBtns_IntervalSchemeKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
...
(* --- Инструменты, отчеты, настройки ----------------------------------------------------------- *)
  ...
  private
    ...
    (*old_Scheme*)//procedure CallSchemeIntervalEditor;
    (*old_Scheme*)//procedure APP_INTERVAL_Handler(var aMsg : TMessage); message APP_INTERVAL;
...
(*old_Scheme*)//PM_IntervalScheme_AcceptModePopup(self);
...
(*old_Scheme*)//SpB_IntervalScheme_Accept.Enabled:=(CurObject.id<>0) and (CatBtns_IntervalScheme.Categories.Count>0);
...
//  end;
//except
//on E : Exception do LogErrorMessage('T_Main.RefreshIntervalScheme',E,[]);
//end;
//end;
//
//
...
(*old_Scheme*)//Btns_IntervalScheme_Click(SpB_IntervalScheme_Clear);
AccidentItem.Clear;
AccidentList.Clear;
...
if (spb=SpB_Mode_Map) or
   ...
   if not SzPan_Area.Visible
      ...
      (*old_Scheme*)//SzPan_IntervalScheme.Hide;
      (*old_Scheme*)//SzPan_IntervalScheme.SendToBack;
      end
      else begin
      case aiitNew of
      aiitArea :
...
//
//
//procedure T_Main._del_CatBtns_IntervalSchemeSelectedCategoryChange(Sender: TObject;
...
//end;
//
//procedure T_Main._del_SzPan_IntervalSchemeResize(Sender: TObject);
//begin
...
//end;
//
//procedure T_Main._del_CatBtns_IntervalSchemeReorderCategory(Sender: TObject; const SourceCategory,
//  TargetCategory: TButtonCategory);
//begin
//RefreshIntervalScheme;
//end;
//
//procedure T_Main._del_CatBtns_IntervalSchemeKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
//begin
...
(*old_Scheme*)//SpB_IntervalScheme_Accept.Enabled:=(CurObject.id>0) and (CatBtns_IntervalScheme.Categories.Count>0) and canWrite;
{$WARN SYMBOL_PLATFORM OFF}
