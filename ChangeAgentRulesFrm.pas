...
begin
  ...
  if MessageDlg('¬ы действительно хотите удалить правило "' + Rule.Caption+'"',
...
begin
  ...
  begin
    ...
    if NOT((sg.RowCount = 2) AND (sg.Objects[0, 1] = nil))  then
      if MessageDlg('«апросив даные из основного набора ¬ы уничтожите неподтвержденные данные наход€щиес€ во временной рабочей таблице.' + #13+#10 + 'ѕродолжить?',
